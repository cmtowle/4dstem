function [atoms,cellDim] = makeSubstrateNP01test(species,nlayers)

% Colin Ophus - 2020 Feb
% Modified Clarissa Bhargava (Towle) - 2020 April; updated July 2021
...
elseif strcmpi(species,'au')
    ...
    disp('Please enter mos2 or au as the species')
end
