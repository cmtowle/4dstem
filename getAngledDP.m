function structDP = getAngledDP(species,nlayers,AuSize,xangle,yangle)
...
% Au nanoparticle or an MoS2 film of a given layer thickness, at a given
...
% xangle -- angle to rotate around x-axis, in degrees
% yangle -- angle to rotate around y-axis, in degrees
...
% Input variables:
flagPlot = true;
substrateSizeApprox = [1 1]*200; %was 150
...
xyTiltSub = [xangle yangle] * pi / 180;
...
% plotImage(fftshift(emdSTEM.MULTI4D),'absolute',jetBlack,[0 0.000005]);
